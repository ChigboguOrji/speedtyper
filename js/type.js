...
function init() {
	let timerBox, scoreBox, letterBox, levelBox, input, start, reset
	...
	let score, level, time, speed, wordList, word, countDownTimer
	...
	function countDown() {
		...
		function timeTick() {
			...
			start.hidden = 1 // hide start button on game start
			return time == 0 ? gameEnd() : null
		}
